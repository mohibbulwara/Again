...
export default function HeroSection() {
  ...
  return (
    <>
      {/* --- PERFECT & FINAL DESKTOP HERO SECTION --- */}
      <section className="relative w-full min-h-[85vh] hidden md:flex items-center justify-end overflow-hidden">
        ...
        <div className="container mx-auto flex items-center justify-end h-full relative z-10 p-4">
          <motion.div
            className="w-full max-w-md bg-black/30 backdrop-blur-sm border border-white/10 rounded-2xl"
          ...
          >
            ...
            <div className="border-t border-white/10 px-8 py-4">
              <div className="flex justify-center gap-6">
                  <motion.a href="https://www.instagram.com/aharian.official/" target="_blank" whileHover={{ scale: 1.2, color: 'hsl(var(--primary))' }} className="text-white/80"><Instagram size={24} /></motion.a>
                  <motion.a href="https://www.facebook.com/aharian.official/" target="_blank" whileHover={{ scale: 1.2, color: 'hsl(var(--primary))' }} className="text-white/80"><Facebook size={24} /></motion.a>
              </div>
            </div>
          </motion.div>
        </div>
