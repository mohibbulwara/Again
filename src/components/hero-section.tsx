...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[85vh] flex items-center justify-end overflow-hidden">
      ...
      {/* Overlay for Desktop only for better text readability */}
      ...
      <div className="container mx-auto flex items-center justify-end h-full relative z-10 p-4">
        {/* Content Container */}
        <div className="w-full max-w-[220px] md:max-w-md md:bg-black/30 md:border md:border-white/10 rounded-2xl md:p-8">
